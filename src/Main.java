...
public class Main {
            ...
            switch (pilihan) {
                ...
                case 2:
                    ...
                    for (Buku buku : perpustakaan.daftarBuku){
                        if(buku.Judul.equals(judulReturn)){
            ...
            if (pilihan == 1) {
                ...
                if (pilihan==1) {
                    ...
                    for (Buku bukuItem : daftarBuku) {
                        if (bukuItem.Judul.equals(judul)) {
                            bukuItem.stok = bukuItem.stok + stokBuku;
                            found = true;
                            break;
                        }
                    }
    ...
    public static void menuLogin() {
            ...
            switch (pilihan) {
                ...
                case 2:
                    ...
                    for (User CurrentUser : daftarUser) {
                        if (CurrentUser.nama.equals(Cekname) && CurrentUser.role.equals(Cekrole)) {
                            loggedIn = true;
                            System.out.println("Login berhasil sebagai " + Cekrole);
                            // System.out.println("=".repeat(30));
                            if (CurrentUser.role.equals("Pustakawan")) {
                                forPustakawan(perpustakaan.daftarBuku);
                            } else if(CurrentUser.role.equals("Pengunjung")){
                                forPengunjung(daftarPustakawan, CurrentUser.nama);
                            }
                        }
                    }
        ...
        for (User user : daftarUser) {
            System.out.println("Nama : " + user.nama + ", Role : " + user.role);
        }
    }
